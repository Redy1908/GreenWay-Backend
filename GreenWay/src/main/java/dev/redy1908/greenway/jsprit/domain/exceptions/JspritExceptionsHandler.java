...
public class JspritExceptionsHandler {
    ...
    @ExceptionHandler(NoDeliveryManToOrganizeException.class)
    public ResponseEntity<ErrorResponseDTO> handleNoDeliveryToOrganizeException(NoDeliveryManToOrganizeException exception,
                                                                                WebRequest webRequest) {
        ErrorResponseDTO errorResponseDTO = new ErrorResponseDTO(
                webRequest.getDescription(false),
                HttpStatus.NOT_FOUND.value(),
    ...
    @ExceptionHandler(NoDeliveryVehicleToOrganizeException.class)
    public ResponseEntity<ErrorResponseDTO> handleNoDeliveryToOrganizeException(NoDeliveryVehicleToOrganizeException exception,
                                                                                WebRequest webRequest) {
        ErrorResponseDTO errorResponseDTO = new ErrorResponseDTO(
                webRequest.getDescription(false),
                HttpStatus.NOT_FOUND.value(),
